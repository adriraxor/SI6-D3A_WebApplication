<div class="modal fade" id="ModalAddOrdinateurmultiple" tabindex="-1" role="dialog" aria-labelledby="ModalLabelAddOrdinateur" aria-hidden="true">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="form-group row">
          <label for="inputNbOrdinateur" class="col-sm-4 col-form-label">Nombre d'ordinateur</label>
          <div class="col-sm-4">
            <input class="form-control" id="inputNbOrdinateur" type="number" name="Ordinateur[nombre]" value="" min="2" onblur="show('hidden')">
          </div>
        </div>
        ...
        <div id="hidden">
          ...
          <div class="form-group row" id="last">
          ...
          <div id="AllinputRefProduit">

          </div>
        </div>


        <input type="hidden" id="inputidEtudiant" name="Ordinateur[idOrdinateur]" value="0">
      </div>
